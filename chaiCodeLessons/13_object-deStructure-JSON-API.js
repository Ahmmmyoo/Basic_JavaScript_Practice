...
const {courseinstructor} = course // object destructuring; "courseinstructor" is the property
const {courseprice: coursePri} = course // "courseprice" is the property, but we name it "coursePri" and use that...

// console.log(`CourseIns: ${courseinstructor} CoursePri: ${coursePri}`)
...
// React Concepts
// const navbar1 = (props.company) => {} // instead of using props.property, we use object destructuring...
// const navbar2 = ({company}) => {} // object destructuring...
